...
from .utility import string_to_number, number_to_string, randrange
from .utility import sigencode_string, sigdecode_string, bit_length
from .utility import (
    oid_ecPublicKey,
...
class VerifyingKey(object):
    ...
    def from_public_key_recovery(
        ...
        :param sigdecode: Callable to define the way the signature needs to
            ...
            second one. See :func:`ecdsa.utility.sigdecode_string` and
            :func:`ecdsa.utility.sigdecode_der` for examples.
    ...
    def verify(
        ...
        :func:`ecdsa.utility.sigdecode_der`
...
class SigningKey(object):
    ...
    def sign_deterministic(
        ...
        :param sigencode: function used to encode the signature.
            ...
            See `ecdsa.utility.sigencode_string` and `ecdsa.utility.sigencode_der`
