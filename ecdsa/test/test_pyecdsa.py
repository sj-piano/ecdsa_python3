...
from ..code.keys import SigningKey, VerifyingKey
from ..code.keys import BadSignatureError, MalformedPointError, BadDigestError
from ..code import utility
from ..code.utility import sigencode_der, sigencode_strings
from ..code.utility import sigdecode_der, sigdecode_strings
from ..code.utility import number_to_string, encoded_oid_ecPublicKey, MalformedSignature
from ..code.curves import Curve, UnknownCurveError
from ..code.curves import (
  SECP112r1,
  SECP112r2,
  SECP128r1,
  SECP160r1,
...
from ..code.ecdsa import (
  curve_brainpoolp224r1,
  curve_brainpoolp256r1,
  curve_brainpoolp384r1,
  curve_brainpoolp512r1,
)
from ..code.ellipticcurve import Point
from ..code import der
from ..code import rfc6979
from ..code import ecdsa
...
class ECDSA(unittest.TestCase):
  ...
  def test_serialize(self):
    seed = b("secret")
    curve = NIST192p
    secexp1 = utility.randrange_from_seed__trytryagain(seed, curve.order)
    secexp2 = utility.randrange_from_seed__trytryagain(seed, curve.order)
...
class Utility(unittest.TestCase):
  def test_trytryagain(self):
    tta = utility.randrange_from_seed__trytryagain
    for i in range(1000):
      seed = "seed-%d" % i
      for order in (
        2 ** 8 - 2,
  ...
  def test_randrange(self, i):
    ...
    for order in (
      ...
      n = utility.randrange(order, entropy=entropy)
      self.assertTrue(1 <= n < order, (1, n, order))
